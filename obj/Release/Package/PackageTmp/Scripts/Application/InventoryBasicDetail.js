var InventoryBasicDetail = {
    ...
    addInventoryBasicDetail: function () {
        ...
        ajaxRequest.makeRequest('/Inventory/InventoryBasicDetails', "POST", data, InventoryBasicDetail.onSuccess, InventoryBasicDetail.onError);
    },
    ...
    fatchCategoryList: function () {
        ...
        ajaxRequest.makeRequest('/CategoryMaster/FatchCategoryByInventoryTypeId', "POST", data, InventoryBasicDetail.onSuccessInventoryType, InventoryBasicDetail.onError);
    },
