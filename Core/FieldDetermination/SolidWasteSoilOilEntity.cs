...
{
    public class SolidWasteSoilOilEntity
    {
    ...
    public class FDSolidWasteInfo
    {
        public SolidWasteSoilOilEntity SolidWasteDetails { get; set; }
        public List<SolidWasteSoilOilEntity> SolidWasteInfos { get; set; }
    }
}
