...
{
    public class StackEmissionMonitoringEntity
    {
    ...
    public class FDStackInfo
    {
        public StackEmissionMonitoringEntity StackDetails { get; set; }
        public List<StackEmissionMonitoringEntity> StackInfos { get; set; }
        public List<StackEmissionMonitoringEntity> StackParaInfo { get; set; }
