...
{
    public partial class FrmQuotationReport : System.Web.UI.Page
    {
        ...
        protected void rvReportViewer_Load(object sender, EventArgs e)
        {
            ...
            //{
            //    if (extension.Name == "IMAGE" || extension.Name == "EXCELOPENXML" || extension.Name == "PDF")
            //    {
        ...
        private void ConvertReportToPDF(LocalReport rep, string reportName)
        {
           ...
           // string fileName = reportName + ".doc";
            //localPath = localPath + fileName;
            //System.IO.File.WriteAllBytes(localPath, bytes);
            //return localPath;
            using (FileStream fs = File.Create(Server.MapPath("/Reports/") + reportName + ".doc"))
            {
                fs.Write(bytes, 0, bytes.Length);
            }
        ...
        Response.ClearHeaders();
            ...
            Response.WriteFile(Server.MapPath("~/Reports/" + reportName + ".doc"));
            Response.Flush();
            Response.Close();
            Response.End();
        }
